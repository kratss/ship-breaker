...
mesh, densities = o3d.geometry.PoissonReconScreened(environment_pcd, depth=8)

# Visualize the reconstructe
# Visualize
o3d.visualization.draw_geometries([environment_pcd, plane_pcd, mesh])
